...
export const createCustomStackedBarChartRequest = async (
  dataset: string,
  filters: Filter[],
  ...
  if (metricsArray.length === 0) {
    throw new Error("At least one metric is required for custom bar chart");
  }
  ...
  "database": "hpcl_ceg",
    "schema": "public",
    "table": dataset,
    "visualization_name": "custom_stacked_bar",
    "organization_id": 6,
  ...
  try {
    ...
    console.error("Error creating custom bar chart:", error);
    throw error;
  }
};