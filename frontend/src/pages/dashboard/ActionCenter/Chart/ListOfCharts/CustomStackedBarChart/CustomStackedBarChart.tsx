...
import CustomStackedBarDataTable from './CustomStackedBarDataTable';
...
const CustomStackedBar: React.FC<StackedBarProps> = ({ data, theme }) => {
  ...
  const option: EChartsOption = {
    tooltip: {
      ...
      formatter: function(params: any) {
        ...
        const nonZeroParams = filteredParams.filter((param: any) => param.data);
    ...
    dataZoom: data.showDataZoom ? [
      {
        ...
        right: 10,
        yAxisIndex: 0,  // Changed to yAxisIndex since we switched axes
        width: 10,
        zoomLock: false
      ...
      },
      {
        ...
        yAxisIndex: 0,  // Changed to yAxisIndex
        ...
        <div className="flex-shrink-0 overflow-auto">
          <Tabs defaultValue="results">
            ...
            <TabsContent value="results" className="h-full overflow-auto">
              <CustomStackedBarDataTable data={data.chartData} />
            </TabsContent>
          </Tabs>
        </div>
      )}
