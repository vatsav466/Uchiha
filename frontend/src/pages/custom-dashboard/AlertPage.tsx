...
import Dashboard from '../custom-charts/Dashboard';
...
const AlertPage = () => {
  return (
    <>
    <div className="container mx-auto px-4 grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mb-4">
      <Card className="p-4">
    ...
    <div className="container mx-auto px-4 grid gap-4 grid-cols-1">
      <Card className="p-4">
        <Dashboard/>
      </Card>
    </div>
