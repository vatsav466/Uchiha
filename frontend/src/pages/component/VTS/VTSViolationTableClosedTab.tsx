...
export const VTSViolationTableClosedTab: React.FC<ROAlertsTableV2Props> = ({ query,onLocationChange,hiddenColumns=[] }) => {
  ...
  const [selectedColumns, setSelectedColumns] = useState<string[]>([
    ...
    'updated_at', 'created_at', 'assigned_user_roles', 'last_escalated_to',
  ...
  const fields = [
    'unique_id', 'sap_id', 'vehicle_number', 'location_name', 'severity', 'violation_name', 
    'created_at','updated_at', 'assigned_user_roles', 'last_escalated_to',
    'last_notified_to'
  ];
...
export default VTSViolationTableClosedTab;