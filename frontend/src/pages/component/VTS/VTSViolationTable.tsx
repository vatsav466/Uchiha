...
import VTSAlertHistoryDialog from './VTSAlertHistoryDialog';
...
export const VTSViolationTable: React.FC<ROAlertsTableProps> = ({ query, onLocationChange }) => {
...
export default VTSViolationTable;