...
const ExpandedCSRejectionChart = () => {
    ...
    useEffect(() => {
        ...
        series.columns.template.adapters.add("fill", (fill, target) => {
            const colors = [
                // am5.color(0xFF6347),  // Tomato Red
                // am5.color(0x32CD32),  // Lime Green
                // am5.color(0xFFD700),  // Gold
                am5.color(0x8A2BE2),  // Blue Violet
                am5.color(0xFF4500),  // Orange Red
                am5.color(0x00FF00),  // Bright Green
                am5.color(0xFF1493),  // Deep Pink
                am5.color(0x00FFFF),  // Aqua
                am5.color(0xFF00FF),  // Magenta
                am5.color(0x800080),  // Purple
                am5.color(0xFFFF00)
            ];
...
export default ExpandedCSRejectionChart;