...
const SubsidyStateamount =({ globalActiveFilters, globalCrossFilters }: SalesComparisonChartProps)=> {
  ...
  const fetchChartData = async () => {
    ...
    try {
      ...
      const response = await apiClient.post("/api/charts/generate_vis_data", {
        ...
        action: "lpg_cdcms_subsidy_state_amount",
        drill_state: "",
      });
...
export default SubsidyStateamount;
