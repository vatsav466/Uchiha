...
const SubsidyTotalamount = ({ globalActiveFilters, globalCrossFilters }: SalesComparisonChartProps) => {
    ...
    try {
      ...
      const response = await apiClient.post("/api/charts/generate_vis_data", {
        filters,
          ...
          action: "lpg_cdcms_subsidy_central_amount",
          drill_state: "",
        });
...
export default SubsidyTotalamount;
