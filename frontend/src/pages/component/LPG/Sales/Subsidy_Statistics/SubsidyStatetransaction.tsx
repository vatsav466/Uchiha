...
const SubsidyStatetransaction = ({ globalActiveFilters, globalCrossFilters }: SalesComparisonChartProps)=> {
  ...
  const fetchChartData = async () => {
    ...
    try {
      ...
      const response = await apiClient.post("/api/charts/generate_vis_data", {
        ...
        action: "lpg_cdcms_subsidy_state_transaction",
        drill_state: "",
      });
  ...
  useEffect(() => {
    fetchChartData();
  }, [filters, crossFilters, drillLevel,globalActiveFilters,globalCrossFilters]);
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-4" style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
              <div className="flex items-center gap-4">
                ...
                State Subsidy Transactions Count
                </CardTitle>
...
export default SubsidyStatetransaction;
