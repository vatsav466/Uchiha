...
interface TicketDetailsSectionProps {
  ...
  // Alert date range filter (for linked alerts query)
  alertsStartDate: string;
  alertsEndDate: string;
  setAlertsStartDate: (value: string) => void;
  setAlertsEndDate: (value: string) => void;
...
export const TicketDetailsSection: React.FC<TicketDetailsSectionProps> = ({
  ...
  const [alertStatus, setAlertStatus] = React.useState<"Open" | "Close">(
    "Open"
  );
        ...
        <FormField label="Location/Plant">
          <MultiSelectCombobox
            ...
            disabled={
              dialogLocationsLoading ||
              dialogZone.length === 0 ||
              (!isEditMode && dialogZone.length > 1) ||
              dialogPlantOptions.length === 0 ||
              formElementsDisabled
            }
            className="h-7 min-h-7 text-xs w-full py-1 px-2 -mt-1"
          />
        </FormField>
                  ...
                  <div className="flex items-end gap-4 flex-1 min-w-0">
                    ...
                    {selectedAlertTypes.length > 0 ? (
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="text-base font-medium text-gray-700 leading-7 shrink-0">
                          Selected:
                        </span>
                  ...
                  <div className="flex items-end gap-4 shrink-0">
                    ...
                    <FormField label="Severity">
                      <ReusableCombobox
                        ...
                        onValueChange={(value) =>
                          setAlertSeverityFilter(String(value))
                        }
                    ...
                    <div className="flex flex-col gap-1 shrink-0">
                      <span className="text-sm font-medium text-gray-700 leading-7">
                        Status
                      </span>
