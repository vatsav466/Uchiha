            ...
            <table className="w-full border-collapse text-xs">
              ...
              <tbody>
                {[...ticketHistory]
                  .sort((a, b) => {
                    try {
                      const aEntry = typeof a === "string" ? JSON.parse(a) : a;
                      const bEntry = typeof b === "string" ? JSON.parse(b) : b;
                      const aTime = new Date(aEntry?.processed_time || aEntry?.allocated_time || 0).getTime();
                      const bTime = new Date(bEntry?.processed_time || bEntry?.allocated_time || 0).getTime();
