...
const MAX_COMMENT_IMAGE_UPLOAD_BYTES = 5 * 1024 * 1024;
        ...
        handlers: {
          image: function (this: { quill: any }) {
            ...
            input.onchange = () => {
              ...
              if (!file) return;
              if (file.size > MAX_COMMENT_IMAGE_UPLOAD_BYTES) {
    ...
    <>
      ...
      <SectionWrapper title="Comments">
        <FormField label="Comment">
          <p className="text-xs text-gray-500 mb-1.5">(upload max 5 MB per file.)</p>
          <ReactQuill
            theme="snow"
            value={comment}
            onChange={setComment}
            ...
            <div className="border-b border-gray-200">
              <nav className="-mb-px flex flex-wrap gap-4">
                <button
                  ...
                  className={`py-2 px-1 border-b-2 font-medium text-sm ${historyTab === "ticket"
                ...
                <button
                  ...
                  className={`py-2 px-1 border-b-2 font-medium text-sm ${historyTab === "alert"
                      ? "border-blue-500 text-blue-600"
                      : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                    }`}
                >
                  ...
                  {alertHistoryIds.map((id) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-2 py-1 rounded border text-xs font-mono ${active
