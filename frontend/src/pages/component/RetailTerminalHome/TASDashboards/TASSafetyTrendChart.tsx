...
const TASSafetyTrendChart: React.FC<EquipmentChartProps> = ({ filters }) => {
  ...
  const chartTitle = `Safety Equipment Analysis`;
...
export default TASSafetyTrendChart