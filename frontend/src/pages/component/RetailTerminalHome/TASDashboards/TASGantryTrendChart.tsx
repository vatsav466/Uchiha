...
const TASGantryTrendChart: React.FC<EquipmentChartProps> = ({ filters }) => {
  ...
  const chartTitle = `Gantry Equipment Analysis`;
...
export default TASGantryTrendChart