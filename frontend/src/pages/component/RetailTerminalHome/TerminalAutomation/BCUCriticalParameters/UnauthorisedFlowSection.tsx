...
import HostUnauthorisedFlow from "./HostUnauthorisedFlow";
import UnauthorisedFlowTrendChart from "../../TASDashboards/BCUCriticalParameter/UnauthorisedFlowTrendChart";

const UnauthorisedFlowSection = ({ filters, zone, plant, filterPortalId }) => { 
...
export default UnauthorisedFlowSection;