...
const LPGVideoAnalytics = () => {  
  ...
  const buildQueryString = () => {
    ...
    const baseQuery = "bu='LPG' AND alert_section='VA'";
  ...
  // Consolidated AlertMediaCard component
...
export default LPGVideoAnalytics;