...
export interface UploadTicketRef {
  openDialog: () => void
  closeDialog: () => void
}

const UploadTicket = forwardRef<UploadTicketRef, ScreenshotReportProps>(
  ({ onSubmit, apiEndpoint }, ref) => {
    const resolvedEndpoint = apiEndpoint ?? "/api/ticketing/create_ticket"
  ...
  try {
    ...
    const saveAndSubmit = async () => {
        ...
        try {
            ...
            // Upload to API
            const uploadResponse = await apiClient.post(resolvedEndpoint, formDataToSend,{
                headers: {
    ...
    return (
        ...
        >
            {/* <DialogTrigger asChild>
                <Button variant="outline" size="sm" className="text-gray-500 justify-start w-[130vh]">
            ...
            <DialogContent className="max-w-6xl max-h-[95vh] overflow-y-auto left-[42%] translate-x-[-50%]">
                <DialogHeader>
                    <DialogTitle>
                ...
                {step === "submit" && (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="subject">
                                    subject <span className="text-red-500 text-xl font-bold align-middle leading-none">*</span>
                                </Label>
                                <Input
                                    id="subject"
                        ...
                        <div className="space-y-2">
                            <Label>
                                Upload File (Screenshot) <span className="text-red-500 text-xl font-bold align-middle leading-none">*</span>
                            </Label>
                            {screenshot && (
            ...
            <div className="text-sm text-muted-foreground">
              <span className="text-red-500 text-xl font-bold align-middle leading-none">*</span> Required fields
            </div> */}
