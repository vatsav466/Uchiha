...
const ProductlevelAgGrid = ({ data }: { data: ProductData[] }) => {
  ...
  return (
    <div ref={gridContainerRef} className="ag-theme-alpine" style={{ height: "520px", width: "100%" }}>
      <style>
        {`
          .custom-header {
...
export default ProductlevelAgGrid;