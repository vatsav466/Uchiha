...
import PerformanceControls from "../charts/PerformanceControls"
...
const DynamicPieBarChart: React.FC = () => {
  const [chartData, setChartData] = useState<any>(null)
  const [isLoading, setIsLoading] = useState<boolean>(true)
  const [expandedChart, setExpandedChart] = useState<string | null>(null)
  const [selectedYear, setSelectedYear] = useState<string>("2024-2025")
  const [error, setError] = useState<string | null>(null)
  const [selectedSBU, setSelectedSBU] = useState<string>("RETAIL")
  const [selectedProduct, setSelectedProduct] = useState<string | null>(null);
  const [marketShareGL, setMarketShareGL] = useState(null);
  const [selectedStartMonth, setSelectedStartMonth] = useState<string>("JAN")
  const [selectedEndMonth, setSelectedEndMonth] = useState<string>("DEC")
    ...
    <div className="p-0 bg-white space-y-2">
      ...
      {isLoading ? (
        ...
        <div className="">
          ...
          sbu={selectedSBU}
  product={selectedProduct}  // Convert to array
...
export default DynamicPieBarChart