...
const SalesPerformanceHeatmap = ({ props, onZoneClick }) => {
  const rowData = props;
  ...
  const getTextColor = (backgroundColor) => {
    return backgroundColor === "#ffeb3b" || backgroundColor === "#ffffff" 
      ? "#000000" 
      : "#ffffff";
  };
  ...
  return (
    <div className="ag-theme-alpine retailPerformanceTable" style={{ height: "500px", width: "100%" }}>
