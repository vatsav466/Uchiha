...
const SalesPerformanceChart: React.FC = () => {
  ...
  */
  ...
  const DrillIndicator: React.FC<DrillStateIndicatorProps> = ({
    ...
    return (
      <div className="space-y-2 text-xs px-8 md:overflow-x-scroll">
    ...
    <>
      <Card className="w-full bg-white rounded-lg border border-gray-200 pt-2 px-2">
        ...
        <span className="text-base font-bold">
          YTD (Apr 01 - {dayjs().subtract(1, "day").format("MMM-DD")} ) - TMT
        </span>
          ...
          <Tabs defaultValue="tab1" className="w-full">
            <TabsList className="grid w-full grid-cols-4">
              <TabsTrigger value="tab1">
                Sales Performance Drilldown
              </TabsTrigger>
              <TabsTrigger value="tab2">
                Sales Performance Selection Wise
              </TabsTrigger>
              <TabsTrigger value="tab3">
                Sales Performance Date Wise
              </TabsTrigger>
              <TabsTrigger value="tab4">
                Sales Performance Month Wise
              </TabsTrigger>
                    ...
                    <div className="flex">
                      ...
                      {mode === "month" && (
                        <CustomMultiSelect
                          ...
                          className="w-auto min-h-4 p-1 text-xs text-black shadow-none border-gray-300 ml-2 md:h-[32px]"
                        />
                      )}
            ...
            <TabsContent value="tab3">
              <SalesPerformanceChartAHTDateFilters />
            </TabsContent>
            <TabsContent value="tab4">
              <SalesPerformanceChartAHTMonth />
            </TabsContent>
          </Tabs>
        </div>
      </Card>
