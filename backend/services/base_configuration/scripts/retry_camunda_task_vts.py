...
CAMUNDA_BASE_URL = "http://10.90.38.218:9092/engine-rest"

camunda_listener_mapping = {
    "camunda_dryout_01": {"host": "10.90.38.218", "port": 9092},
    "camunda_dryout_02": {"host": "10.90.38.218", "port": 9093}
}
...
def main():
    try:
        for key, values in camunda_listener_mapping.items():
            url = f"http://10.90.38.218:{values['port']}/engine-rest"
